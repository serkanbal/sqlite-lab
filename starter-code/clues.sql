...
SELECT name,population,code character from country WHERE region = 'Southern Europe'  ORDER BY population ASC;
Holy See (Vatican City State)|Southern Europe|1000|VAT
...
SELECT countrycode,percentage FROM countrylanguage WHERE "language" = 'Italian’;
...
Serra
SELECT countrycode character FROM city WHERE name = 'Serra';
BRA
